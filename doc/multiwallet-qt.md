...
In order to support loading of multiple wallets in yotoken-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is yotoken.cpp.
...
Changes to yotoken.cpp
-------------------

yotoken.cpp is the entry point into yotoken-qt, and as such, will require some minor modifications to provide hooks for
