...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("yotoken Core yotoken-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  yotoken-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded yotoken transaction") + "\n" +
                               "  yotoken-tx [options] -create [commands]   " + _("Create hex-encoded yotoken transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded yotoken transaction
