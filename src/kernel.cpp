...
{
    //yotoken will hash in the transaction hash and the index number in order to make sure each hash is unique
...
{
	// yotoken TODO: renable once stacking generates a checkpoint
    /*
