...
/** Utility functions used by the yotoken Qt UI.
 */
namespace GUIUtil
{
...
// Render yotoken addresses in monospace font
...
// Parse "yotoken:" URI into recipient object, return true on successful parsing
