...
/** Utility functions used by the yotokens Qt UI.
 */
namespace GUIUtil
{
...
// Render yotokens addresses in monospace font
...
// Parse "yotokens:" URI into recipient object, return true on successful parsing
