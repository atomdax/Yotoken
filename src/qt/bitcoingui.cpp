                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("yotoken") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a yotoken address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and yotoken:URIs)"));
...
*/
    ...
    aboutAction = new QAction(QIcon(":/icons/info_menu"), tr("&About yotoken Core"), this);
    aboutAction->setStatusTip(tr("Show information about yotoken Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for yotoken"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your yotoken addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify_menu"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified yotoken addresses"));
    ...
    openAction->setStatusTip(tr("Open a yotoken:URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the yotoken Core help message to get a list with possible yotoken command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("yotoken Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to yotoken network", "", count));
}
...
{
    QString strTitle = tr("yotoken"); // default title
